...
class ioHubConnection(object):
    ...
    def _startServer(self,ioHubConfig=None, ioHubConfigAbsPath=None):
        ...
        print("rootScriptPath: %s" % rootScriptPath)
        ...
        #changed the path for .iohpid to the user home dir because the rootScriptPath is not writable.
        #iopFileName=os.path.join(rootScriptPath ,'.iohpid')
        iopFileName = os.path.join(user_home_path, '.iohpid')
